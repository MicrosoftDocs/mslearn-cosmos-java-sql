...
public class QuerySample implements CommandLineRunner {

    private final Logger logger = LoggerFactory.getLogger(QuerySample.class);

    @Autowired
    private QueryUserRepository userRepository;

    @Autowired
    private QueryReactiveUserRepository reactiveUserRepository;
